...
curBivData_PWD.good.foci <- PWD.auto.man_BivData[PWD.auto.man_BivData$foci.pass == 1,]
...
```{r melt.KAZ, echo=FALSE}

#use the combined - auto and manual data

curBivData_KAZ.good.foci <- KAZ.auto.man_BivData[KAZ.auto.man_BivData$foci.pass == 1,]
#curated objects
...
curBivData_KAZ.good.foci <- KAZ.auto.man_BivData[KAZ.auto.man_BivData$foci.pass == 1,]
colnames(curBivData_KAZ.good.foci)

curBivData_KAZ.good.foci$nrm.F1.pos <- curBivData_KAZ.good.foci$Foci1 / curBivData_KAZ.good.foci$chromosomeLength
curBivData_KAZ.good.foci$nrm.F2.pos <- curBivData_KAZ.good.foci$Foci2 / curBivData_KAZ.good.foci$chromosomeLength
curBivData_KAZ.good.foci$nrm.F3.pos <-   curBivData_KAZ.good.foci$Foci3 / curBivData_KAZ.good.foci$chromosomeLength
...
fit.PWD <- fitdistr(all.2CO$IFD1_PER[all.2CO$strain == "PWD"], "exponential")#change to gamma
fit.KAZ <- fitdistr(all.2CO$IFD1_PER[all.2CO$strain== "KAZ"], "exponential")


PWD.curve <- hist(all.2CO$IFD1_PER[all.2CO$strain == "PWD"], freq = FALSE, breaks = 100, xlim = c(0, quantile(ex, 0.99)))+
