...
- re-run analyses with sd

- Cecile's comment on transformations...
...
#TOTAL SC should already be loaded into Results
#XXXXTotal.SC_DF = read.xlsx2("~./MLH1repo/data/Total.SC_DF.xlsx", header=TRUE, 1)
...
Dom.female.VAR.plot <- ggplot( data = (female_mouse.avs_for.analysis %>% filter(subsp == "Dom") ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = var, color= strain), width = .2 )+ ggtitle("Dom female\nwithin mouse \nMLH1 variance") + scale_color_manual(values=colors_of_strains)


```


```{r mouse.SD.plots.female, echo=FALSE, fig.width = 4, fig.height=2.5, warning=FALSE}

#variance plots
musc.female.SD.plot <- ggplot( (female_mouse.avs_for.analysis %>% filter(sex== "female") %>% filter(subsp == "Musc") ) , aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("Musc female of within mouse \nMLH1 s.d.")+scale_color_manual(values=colors_of_strains)
musc.female.SD.plot

Mol.female.SD.plot <- ggplot( (female_mouse.avs_for.analysis %>% filter(subsp == "Mol") ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("Mol female\nwithin mouse MLH1 s.d.")+scale_color_manual(values=colors_of_strains)
Mol.female.SD.plot

Dom.female.SD.plot <- ggplot( data = (female_mouse.avs_for.analysis %>% filter(subsp == "Dom") ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain), width = .2 )+ ggtitle("Dom female\nwithin mouse \nMLH1 s.d.") + scale_color_manual(values=colors_of_strains)
Dom.female.SD.plot
...
```{r mouse.sd.plots.male, echo=FALSE, fig.width = 4, fig.height=2.5, warning=FALSE}
#variance plots
OG.male.sd.plot <- ggplot(data = (male_mouse.avs_for.analysis %>% filter(subsp == "Dom")  ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y =sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("SD Musc male of within mouse MLH1 distributions")+scale_color_manual(values=colors_of_strains)
OG.male.sd.plot

Musc.male.sd.plot <- ggplot(data = (male_mouse.avs_for.analysis %>% filter(subsp == "Musc")  ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("SD Musc male of within mouse MLH1 distributions")+scale_color_manual(values=colors_of_strains)
Musc.male.sd.plot

Mol.male.sd.plot <- ggplot(data = (male_mouse.avs_for.analysis %>% filter(subsp == "Mol")  ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("SD Mol male of within mouse MLH1 distributions")+scale_color_manual(values=colors_of_strains)
Mol.male.sd.plot


Dom.male.sd.plot <- ggplot(data = (male_mouse.avs_for.analysis %>% filter(subsp == "Dom")  ), aes(color= strain))+geom_jitter(aes(x = as.factor(strain), y = sd, color= strain, alpha=0.5), width = .2 )+ ggtitle("SD Dom male ofwithin mouse  MLH1 distributions")+scale_color_manual(values=colors_of_strains)
Dom.male.sd.plot
```
...
Cor.plot <- ggplot(( FULL_mouse_table_Q12.MLH1 %>% filter(species == "M.musculus") ), aes(x=mean_co, y=var, color = strain)) + 
  geom_point() +   facet_wrap(~sex)+scale_color_manual(values=colors_of_strains, guide = FALSE) +  geom_text(data= small.DF, aes(x=27, y=40, label=corr),  colour="black", inherit.aes=FALSE, parse=FALSE ) +  geom_text(data= small.DF, aes(x=27, y=35, label=p.val),  colour="black", inherit.aes=FALSE, parse=FALSE )+ggtitle("Mean by CO variance per Mouse")+ylim(c(0,40))
...
pwd.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = pwd.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "PWD"] ) + ggtitle("PWD difference in variance across sexes")  + annotate("text", x=3.6, y=750, label= "p=" ) + annotate("text", x=5.1, y=750, label= sum(FM.var.diff_permuted$pwd.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "PWD"] ) / nrepeat )  
pwd.perm2.plot

skive.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = skive.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "SKIVE"] ) + ggtitle("SKIVE difference in variance across sexes") + annotate("text", x=3, y=750, label= "p=" ) + annotate("text", x=7, y=750, label= sum(FM.var.diff_permuted$skive.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "SKIVE"] ) / nrepeat )
skive.perm2.plot

msm.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = msm.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "MSM"] ) + ggtitle("MSM difference in variance across sexes")+ annotate("text", x=3, y=750, label= "p=" ) +annotate("text", x=4, y=750, label= sum(FM.var.diff_permuted$msm.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "MSM"] ) / nrepeat )
msm.perm2.plot

g.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = g.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "G"] ) + ggtitle("G difference in variance across sexes")+ annotate("text", x=3, y=750, label= "p=" ) +annotate("text", x=4, y=750, label= sum(FM.var.diff_permuted$g.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "G"] ) / nrepeat )
g.perm2.plot

wsb.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = wsb.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "WSB"] ) + ggtitle("WSB difference in variance across sexes")+ annotate("text", x=3, y=750, label= "p=" ) +annotate("text", x=4, y=750, label= sum(FM.var.diff_permuted$wsb.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "WSB"] ) / nrepeat )
wsb.perm2.plot


lew.perm2.plot <- ggplot(FM.var.diff_permuted, aes(x = lew.FM.dif)) + geom_histogram() + geom_vline(xintercept = Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "LEW"] ) + ggtitle("LEW difference in variance across sexes")+ annotate("text", x=3, y=750, label= "p=" ) +annotate("text", x=4, y=750, label= sum(FM.var.diff_permuted$lew.FM.dif >= Diff.Var$Fvar.Mvar.dif[Diff.Var$strain == "LEW"] ) / nrepeat )
lew.perm2.plot
