...
#remove y labfor male 
  ...
  #label
  annotate("text", x = c(2,5,7.15), #list of all x points 
           y = c(18.5,18.5, 18.5),
...
fig1_B_v2  <- ggdraw() +
  draw_plot(Fig1_Bv2_strain.female, x=0, y = 0, width=.5, height=.97) +
  draw_plot(Fig1_Bv2_strain.male, x=.45, y=0, width=.5, height=.97) +
