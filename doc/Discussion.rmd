...
Under **spindle based model** we hypothesize that the sexual dimorphism in the recombination landscapes hinges on sex differences on the requirements for chromosome cohesion in late meiosis I. <1> the irreversible process of the metaphase to anaphase transition is initiated by the protyltic decay of the sister cohesion connecting homologs (referred to as along the tetrad arms (cite)).

<2> The number and placement of crossovers alter the distribution of sister cohesion and the 'chromosome structure' which is a consequence of kinetochores attaching to the MT-spindle and tension applied. Single crossover bivalents form what is known as cruciform tetrad in some systems (figure x). This area is reduced when crossover positions are shifted towards the telomere ends of the chromosome. The male crossover telomere bias could be adaptive in order to synchronize (or minimize) the timing of homologs separating at metaphase I.	

<3> Conserved feature of gametogenesis -- is the length of timing of the cell cycle (difference between spermat.
faster spermatogenesis -- may select for synchronize the separation homologs or faster separate after alignment at metaphase. While in oogenesis, the longer timing and arrests may select for overall more sister cohesion (a different homolog structures)
...
Interference is a fundamental aspect of the recombination landscape. -- genome-wide recombination rate and chromatin compaction
