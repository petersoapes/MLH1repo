...
Just as the difference in SAC (checkpoint) strength can lead to disinct evolutionary trajectories of the genome wide recombination rate for oocytes and spermatocytes, the other side of the same coin is that there is increased variance between cells for crossover number. (weaker / leaky checkpoint )
