...
prev reported sex diffferences in 
...
Our results had two notable instances of evolution in the recombination rate (or correlated trait); evolution of precursor number (DSBs) and crossover interference strength.


## DSBs

Our results find evolution between a subset of strains -- demonstrating that the high rec strains have greater DSB number

Evolution of recombination rates via the number of precursors -- (has been proposed -- ) (Bairer et al). Likely // evidence suggests this pattern is also a feature of the sex differences.
...
Together these results indicate that (it's not the CO : NCO decision but an earlier step (when the total number of chromatin loops (the substrate for SPO11, are laid down with the establishment of the meiotic chromosome structure (DNA loop size)

The tethered loop model of DSB formation
...
_the resuts support / replicate those reported in Baier et al_
...
the correlation of DSB marker with MLH1 
