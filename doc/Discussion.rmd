...
## Broad Scale crossover placement patterns, male telomeric, female centromeric 'Typical landscape'
...
1. Cattle (Ma?) [@ma2015cattle] ? (or newer one), when comparisons of genetic map length and interference strength are made across strengths within sex, the strain with the higher genome wide recombinaiton rate also has stronger interference (measured as nu gamma parameter)
...
In our analysis / synthesis of results, we decded to test and systematically compared models which have been proposed to explain our results (both for the sex dfferences and the faster male evolution of recombination rates).  We attempted to test the hypotheses of if our choosen models could produce the main / general patterns oberved in this study (Table X)

We generall focus on models for the evolution of heterochiasmy since that is the primary data/set of results in this study. We search for a parsimonius explanation /model that fits both the results from sex differences and the faster male evolution.
