...
The direction of heterochiasmy under the two locus modifier model is dependent on female specific recombination modifier suppresses or increases recombination, if the modifier is linked to the driving locus, and the meiotic stage (reduction (MI) or equatorial division (MII)) when the driver acts (see Table 1 of @brandvain2012scrambling).
