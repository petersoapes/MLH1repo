...
Under **spindle based model** we hypothesize that the sexual dimorphism in the recombination landsacpes hinges on sex differences on the requirements for chromosome cohesion in late meiosis I. <1> the irreversable process of the metaphase to anaphase transistion is initiated by the protyltic decay of the sister cohesion connecting homologs --along the tetrad arms (cite).

<2> The number and placement of crossovers alter the distribution of sister cohesion and the 'chromosome stucture' once kinetochores attached to MT-spindle and tension applied.  For single acrocentric chromosomes the sister cohesion distal to the crossover connects the homologs (when aligned on metaphase plate). This is known as cruciform tetrad is some systems.

This area is reduced when crossover position is shifted towards the telomere (ends of the chromsome). 

The male crossover telomere bias could be adaptive in order to synchornize (or minimize) the timing of homologs sepearting at metaphase I.	

<3> Conserved feature of gametogenesis -- is the length of timing.
faster spermatogenesis -- may select for synchronize the separation homologs or faster seperate after alignment at metaphase. While in oogenesis, the longer timing and arrests may select for overall more sister cohesion (a different homolog strucutres)

<In oocytes the slower cell cycle and prolonged arrest may require chromosome structures with greater stability on the MI spindle.> 	
