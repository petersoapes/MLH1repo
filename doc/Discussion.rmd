...
Male biased heterochiasmy is predicted under the two locus modifier model when XXXX.  <does parameterize cases for male biased heterochiasmy, dependent on the stage of action for the driver (MI or MII) and the linkage status (see table 1 Brandvain and Coop).>
