...
This section refers to the matrix of models and results from this study where we (conceptually test if each model would support our results)

We were motivated to run a comparison of 
...
This new model has _strengths_
...
## 4. Spindle   // Difference in acentromeric spindle and SAC
...
we like this model because it can be applied to _both our results_ for i) sexual dimorphism variation and ii) the fast male evolution in gwRR and recombination landscape.

for the distinct _evolutionary patterns_ selection on the recombination landscape via the spindle (segregation checkpoint), 
...
-  more attention to cell physiology
