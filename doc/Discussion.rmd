...
1c. sex differences in the SAC strength connected to conserved features of gametogenesis
- Sperm SAC strong (can detect 1 unstable bivalent) and oocyte SAC weak / 'leaky' achiasmate chromosomes pass through and higher rate of annueploidy
...
1d. directional selection could be seen under strict SAC if the fitness landscape for 'chromosome structure' is altered via genetic architecture changes or GxE effects.
```
...
The two locus modifier model  does parameterize cases for male biased heterochiasmy, dependent on the stage of action for the driver (MI or MII) and the linkage status (see table 1 Brandvain and Coop).
