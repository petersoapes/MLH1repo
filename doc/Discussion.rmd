...
A consequence of the sexual dimorphism in broad scale recombination landscapes is that the male recombination pattern drives divation from an uniform distribution in any sex averaged recombination landscape [@sardell_sex_2020]. Elevation at the chromosome ends is a conserved trait across animals and plants and has a consequence of higher genetic diversity near chromosome ends [@haenel2018].
...
An expected consequence of our observed elevated genome-wide recombination rate is lower LD, which may increase the efficiency of selection and impact the dynamics of intrgresion. However given that the higher genome-wide recombination rates are paired with stronger interference these predicted pattern may have heterogenous signal along chromosomes.
