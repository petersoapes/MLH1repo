...
Under **spindle based model** we hypothesize that the telomeric placement of crossovers in the male recombination landscape, minimizes the amount of sister cohesion connecting homologs. the irreversable process of the metaphase to anaphase transistion is initiated by the protyltic decay of the sister cohesion connecting homologs (cite).

<2> The number and placement of crossovers alters the lay-out / distribution of sister cohesion and the 'chromosome stucture' once kinetochores attached to MT-spindle and tension applied.  For single acrocentric chromsoomes the sister cohesion (area of the chromosome) distal to the crossover connects the homologs. (known as cruciform tetrad is some systems). (this is the part of the tension force read by the SAC).	
...
<3>
This conserved feature of the male recombination landscape, might act to synchronize the separation homologs after alignment at metaphase, (and in the degargation of the sister cohesion connecting the homologs. Another conserved feature of gametogenesis is that the timing of spermatocyte metapphase is much shorter of time compared to oocytes.


Whereas, in males, the directional selection could cause decreased variance in the recombination landscape via telomeric positioning of crossovers.

Under the telomeric bias  recombination landscape, entry into anaphase may be more synchronizes (and faster) given that the reductional separation of homologs is dependent on a minimal amount of sister cohesion connecting the homologs (Figure X).
