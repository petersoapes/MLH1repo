...
A thing about this study that we were very interested in was examining the faster evolution in males with the high recombining rates. BUT applying these above models to the traits connected to the faster male evolution is a bit tricker since none of these moedls were designed to explain within species variation in recombination rates. (most were designed to explain the general pattern of sexual dimorphism in meiotic recombination rates.)
...
The strongest correlate of faster gwRR in males was intercrease interference strength. This is unexpected beacuse most literature and logical models assoicate more dense spacing of crossovers along chromosomes. Luckily having unexpected results is good for distingushing the most parimonius model. These results were unexcepted and differ ffrom the major patterns listed in the literature (otto payseur, argawal Korol. (it also goes against the logical assumptions models of fitting more crossovers along the SC chromosome axis space)
...
We considered carefully if this pattern was due to error -- and we are confident that this pattern is genuine -- goes aginst expected noise ALSO this is observed from other work in this lab -- and some empiracal studies (cattle) (plant bomblies).

<while these results don't clearly fit the chromatin organization and interference strength prediction... determining the clean pattern is beyond the scope of this paper>


HOW do the models above treat this unexpected correlation?

**typical modifer models -- are not good for predicting interferece (in mode that is relevant to these types of results) since the models don't parameterize for indiviual meiosis events.** We conclude that under the haploid selection and meiotic driver model any prediction for evolution of interference strength follows from the 'logical' expectation of a negative correlation.
