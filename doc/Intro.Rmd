...
•	While there are fewer measures from closely related species, variation at this level is more restricted to finer scales (hotspot level / recombination landscape level). **find a good citation for this**

1b. Sex is one of the most notable axes along which individuals vary 

•	Long history since the discovery -- in fruit flies and silk moths at the turn of the 20th century (cite sturavant)
...
A early pattern of heterochiasmy that emerged was that in many species females have more recombination compared to males, considered female bias-heterochiasmy. However as observations have expanded to more species, more examples of male biased heterochiasmy have been observed; including cattle, marsupials, (fish)  (while birds have a smaller overall degree of heterochiasmy)

A more conserved feature of heterochiasmy As discussed in Sardell Kirkpatrick, are the broad scle differences in the placement of crossovers along chromosomes.

In male recombination landscapes, there is a bias towards the ends near the telomeres while in females crossovers are more uniformly placed (and occur closer to the centromere compared to males).

(the degree of this pattern varies across species (some have female biased telomere-bias, some have chromosome specific patterns and others have no significant sex difference. It's worth pointing out that the exceptions may require modifed assumptions as to how the meiotic program evolves; marsupials form chromosome chains during meiosis, some fish species has sequential hermaphrodism, and birds have many microchromosomes chromosomes. <grasshoppers?>
...
Overall house mouse -- using the house mouse model -- will better allow narrowing in on the causes // developing testable hypotheses for explaining any (particular patterns) variation discovered.
