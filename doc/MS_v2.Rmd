...
Although there is a positive correlation between total SC length and MLH1 foci when both traits are measured as mouse means (Spearman’s r = 0.48 --`r cor( totSC.mouse.av.table$mean.skel, totSC.mouse.av.table$mean.MLH1, method = c("spearman") )`; p = 2.2410^{-10} -- `r cor.test(totSC.mouse.av.table$mean.skel, totSC.mouse.av.table$mean.MLH1, method=c("spearman") )$p.value` ), total SC length only partially differentiates high-recombination strains from low-recombination strains (Figure 5). 
