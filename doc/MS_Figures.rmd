...
#aes(x=strain, y=total.count, color=stage

DMC1.boxplot <- ggplot( aes(x=strain, y=total.count, color=stage), data=DMC1.DF[DMC1.DF$stage != "P",])+
  
  #stat_boxplot( aes(x=strain, y=total.count, color=stage), 
 #   geom='errorbar', linetype=1, width=0.5)+
  
  geom_boxplot( aes(x=strain, y=total.count),outlier.shape = NA, alpha=.5 )+
