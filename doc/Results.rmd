...
Q1.real.short_mouse_table <- add_species(Q1.real.short_mouse_table)
...
Q1.real.short_mouse_table$species <- factor(Q1.real.short_mouse_table$species, ordered = FALSE)
...
```{r Q1.SC.long.biv_wacko, echo=FALSE, include=FALSE}
...
#remove SKIVE
Q2.1COpos_short_ttest_HL.ex <- t.test( (Q2mouse.av.short.biv.table  %>% filter(Rec.group.exclu == "0"))$norm.first.foci.pos, 
