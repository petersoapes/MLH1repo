...
While testing the sex differences, there were results (the significant subspecies effect) which suggest that the _musculus_ and _molossinus_ strains had longer SC compared to the domesticus strains - these two strains also contain the high rec strains - motivating a model/hypothesis that sc length / chromatin compaction evolution may facilitate the rapid male specific evolution in genome wide recombiantion rate.
