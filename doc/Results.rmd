...
(t.test; p= `r Q1_mus.av_shortSC_t.test.PWD$p.value`, `r Q1_mus.av_shortSC_t.test.KAZ$p.value`, and `r Q1_mus.av_shortSC_t.test.SKIVE$p.value`

for PWD, KAZ, SKIVE and MSM.
...
```{r Q1_SC.biv.long_ttest, echo=FALSE}
...
mixed models and glms were donw to test for evolution
...
```{r Q1.SC_short_t.test, echo=FALSE}
