...
P1.by.P2_plot_raw <- ggplot(Curated_BivData.22, aes(y = Foci2, x= Foci1, color=strain))+
  geom_jitter(alpha=.2)+
  ggtitle("Normalized IFD")+
  scale_color_manual(values=colors_of_strains)+  facet_wrap(sex~subsp, scales = "free")+theme(legend.position="none")
