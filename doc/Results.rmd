...
The first use t.tests to test if there are significant differences in the single CO landscapes between the high and low rec groups. 

T tests of the single crossover positions reveal that the normalized 1 foci positions are not significantly different between the total pooled high and low rec male strains (t.test; p = `r Rec.group_BivData_F1post_Ttest$p.value`). 
