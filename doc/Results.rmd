...
load(file="~./MLH1repo/data/CleanBivData_12.2.20.RData")
...
```{r mixed.model.data.setup, echo=FALSE, warning=FALSE, eval=TRUE}
...
<<<<<<< HEAD
```{r Q1.SC.show.long.biv, echo=FALSE, eval=FALSE}


mouse.shoo.long.biv <- ggplot(real.long.bivData, aes(y=chromosomeLength, x=strain, color=strain))+geom_jitter()+facet_wrap(~subsp, scales = "free")+scale_color_manual(values=colors_of_strains)+ylim(c(75,140))+geom_boxplot(alpha=.2) + ggtitle("Mouse av. \nMale Long Biv SC Lengths")
=======
```{r Q1.SC.show.long.biv, echo=FALSE}


mouse.shoo.long.biv <- ggplot(real.long.bivData, aes(y=mean.sc, x=strain, color=strain))+geom_jitter()+facet_wrap(~subsp, scales = "free")+scale_color_manual(values=colors_of_strains)+ylim(c(75,140))+geom_boxplot(alpha=.2) + ggtitle("Mouse av. \nMale Long Biv SC Lengths")
>>>>>>> 7ebba2e601079e1783e92c05ba74529ea765a5ed
mouse.shoo.long.biv  
...
<<<<<<< HEAD
```{r Q2.SC.long.biv_wacko, echo=FALSE}
=======
...
anova(lmer.IFD.ABS_MM.M1, lmer.IFD.ABS_MM.M1.reduce.sex)
anova(lmer.IFD.ABS_MM.M1, lmer.IFD.ABS_MM.M1.reduce.subp)

drop1(lmer.IFD.ABS_MM.M1, test="Chisq" )

exactRLRT(lmer.IFD.ABS_MM.M1)
...
#mouse.av.long.biv.table <- make this is set up
