...
expectations, predictions if this is the case
...
```{r DMC1_MLH1.cor, echo=FALSE, warning = FALSE}
...
The table above indicates, there is not much variation across the MLH1 : DMC1 ratio (a proxy for the proportion of NCO).

The correlation with MLH1 and leptotene cells is `r MLH1.DMC1.L_cor`. The correlation with MLH1 and zygotene cells is `r MLH1.DMC1.Z_cor`.
