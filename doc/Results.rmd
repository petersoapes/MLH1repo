...
color_chrm_class <- c( '0' = "#00BFC4", '1' = "#7CAE00", '2' = "#F8766D", '3' = "#C77CFF")
...
#SC.skel
#"anon.batch" "rand_name"  "bin_size"   "skel_size" 
...
!Note! the most recent tot.sc csv was missing ~2 batches... rerun


```{r tot.sc.viz4outliers, echo=FALSE}

tot.sc <- ggplot(data= MLH1.merge.Skel, aes(y = bin_size, x=mouse))+ geom_point()
tot.sc2 <- ggplot(data= MLH1.merge.Skel, aes(y = skel_size, x=mouse))+ geom_point()
