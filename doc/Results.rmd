...
Short_biv_Nested_boxplots <- ggplot(real.short.bivData, aes(y = chromosomeLength, x=strain, fill=as.factor(hand.foci.count) ))+geom_boxplot(aes(alpha=0.5))+ggtitle("Short Biv \nSplit by Chrm Class")+facet_wrap(subsp~sex, scales="free")+ylim(c(25,150))
Short_biv_Nested_boxplots
