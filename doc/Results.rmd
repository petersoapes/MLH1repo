...
```{r JUNK.Q1.SC_short_t.test, echo=FALSE, include=FALSE}

#t.tests for a
Q1_short.sc_t.test.WSB <- t.test((Q1.real.short_mouse_table %>% filter(sex == "male") %>% filter(strain == "WSB") )$mean_SC,
                           (Q1.real.short_mouse_table %>% filter(sex == "female") %>% filter(strain == "WSB") )$mean_SC)
#sig


#Using the full data set has strong signle but -- the interpertation is complicated
#FULL SC t.test
#run a t.test
