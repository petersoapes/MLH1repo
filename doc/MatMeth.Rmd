...
Mean **DMC1** foci per cell for a single mouse from a subset of srains *musculus^PWD^*, *musculus^MSM^*, *domesticus^WSB^*, and *domesticus^G^* were compared by t-tests.
SC morphology was used to stage spermatocytes in the zygotene, leptotene, or pachtyene cell stage. 
