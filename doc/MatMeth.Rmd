...
#set wd
#load datafile
load(file="~./MLH1repo/data/Results_setup_4.16.20.RData")
...
Spermatocyte spreads were collected and perpared as described in [@peterson2019] . The majority of mice used were between 5 and 12 weeks, (supplemental table). for DMC1 spreads we targeted juvinile male mice (X ages). 
...
The means of DMC1 foci per cell from a single mouse from a subset of srains *musculus^PWD^*, *musculus^MSM^*, *domesticus^WSB^*, and *domesticus^G^* were tested by t-tests.
