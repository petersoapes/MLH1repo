...
ToDo -- add more hand curated data for the bivalent proportions


```{r chrm_prop_data, echo=FALSE, eval=FALSE}
...
other_thing <- ggplot(data = melt.table, aes(y = value, x = strain, fill=as.factor(type)) ) + geom_col(position = "dodge")+facet_grid(sex~subsp, scales = "free")+ggtitle("Chrm Proportions from Hand Measured")+ylim(c(0,1))
