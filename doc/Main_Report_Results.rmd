...
Q12_mouse_table_w.Ages$subsp <- ifelse(grepl("MSM", Q12_mouse_table_w.Ages$strain), "Mol", 
        ifelse(grepl("MOLF", Q12_mouse_table_w.Ages$strain), "Mol", NA))


#Q12_mouse_table_w.Ages

M1.Q12_var_co <- lme( var ~ subsp * sex, data=Q12_mouse_table_w.Ages, random=list(strain=pdDiag(~sex) ) )

as.data.frame( round(summary(M1.Q12_var_co)$tTable, 6))
