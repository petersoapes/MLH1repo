...
in addition to the mean gwRR, the variance is also an important metric to dicribe 
...
A general pattern is that the female data has higher within mouse variance (both var and cV). I think the dissection date needs to be tested as a predictor factor.  It might be tricky to add the dissection date metric. 
...
list out the points whic hsuport rapid male specific evolution for MLH1 rates.
