...
Currently I ran through 3 data sets: 1) base, 2) HQ and 3) Molf (from HQ)
...
subspecies levels: 2(3), Musc and Domestics (Mousiness)
...
Above is the table of coefficients for MM.2.2, HQ data set, gls(), No random effects.  
...
When Molossinus is coded as a separate subspecies, then interaction terms are no longer significant.
