...
IFD.Male.DOM.tri.plot


basey.base <- plot( y = (Curated_BivData %>% filter(sex == "male") %>% filter(hand.foci.count == 2) %>% filter(subsp == "Dom") )$PER_Foci_2, x= (Curated_BivData %>% filter(sex == "male") %>% filter(hand.foci.count == 2) %>% filter(subsp == "Dom") )$PER_Foci_1 )
