...
```{r double.tri.rewrite, echo=FALSE, eval=FALSE}
#good function, saves to file, can't reproduce in rmd
...
bottom.triangle2 <- function(my.y, my.x, my.data){
  ...
  mtext("Position.1.Male", 4, 3, padj=par()$usr[1] + 10)
  x.at <- axisTicks(par()$usr[1:2], 0) + x.dist
