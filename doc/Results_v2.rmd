...
Confirming the basic predictions, there is a positive correlation between mean MLH1 foci per cell and total SC  `r cor(totSC.mouse.av.table$mean.skel, totSC.mouse.av.table$mean.MLH1)`. Nevertheless, mean total SC only partially differentiates high-recombination and low-recombination strains (Figure X).  <Bret's note on positive correlation, 'A correlation across mice, across strains, or both?'>
