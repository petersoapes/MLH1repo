...
age.effect.plot.mm <- ggplot(mm, aes(y=mean.MLH1, x=quality, color=(strain) ))+geom_point()+ 
...
age.effect.plot.ff <- ggplot(ff, aes(y=mean.MLH1, x=quality, color=(strain) ))+geom_point()+ 
  scale_color_manual(values=colors_of_strains)+ #this list in setupdata
...
skel.histgram <- ggplot(MLH1.merge.Skel, aes(x=skel_size)) +  geom_histogram(bins=50)
skel.histgram
