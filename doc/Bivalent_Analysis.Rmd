...
The DF **real.long.bivData** contains `r length(real.long.bivData$Obj.ID)` bivalent measures. full data set is 
...
#cell 5aug17_14jul17_LEW_f1_sp1_11_rev is missing measures for 2 bivs
...
#remove the incomplete MSM cell
