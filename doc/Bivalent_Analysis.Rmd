...
SCLength_all_.MM.M1 <- lmer(mean_co ~ subsp * sex + (1|strain), data=mouse.avs_4MM) 
#summary(Reduced.strain.HQ)

drop1(SCLength_all_.MM.M1, test="Chisq") # p = 0.0002045 ***

exactRLRT(SCLength_all_.MM.M1) #< 2.2e-16  Random strain effect, the variance due to random strain effect is NOT 0
as.data.frame(round(summary(SCLength_all_.MM.M1)$tTable, 6))
