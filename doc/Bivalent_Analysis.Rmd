...
```{r blah.again, echo=FALSE, eval=FALSE}
...
Rec.group_IFD.ABS_test <- t.test(Curated_BivData$IFD1_ABS[ ( Curated_BivData$sex == "male" ) & (Curated_BivData$subsp == "Musc") & (Curated_BivData$Rec.group ==0 )],
     Curated_BivData$IFD1_ABS[ ( Curated_BivData$Rec.group ==1 )]
)#p-value = 7.955e-05

Rec.group_IFD.ABS_test$p.value

Rec.group_IFD.PER_test <- t.test( Curated_BivData$IFD1_PER[ ( Curated_BivData$sex == "male" ) & (Curated_BivData$subsp == "Musc") & (Curated_BivData$Rec.group ==0 )],
     Curated_BivData$IFD1_PER[ ( Curated_BivData$Rec.group ==1 )]
)#p-value = 0.04231

Rec.group_IFD.PER_test$p.value

biv.IFDs <- ggplot(Curated_BivData[ ( Curated_BivData$sex == "male" ) & (Curated_BivData$subsp == "Musc"),], aes(y = IFD1_ABS, x= mouse, color=strain))+geom_boxplot(alpha=.2)+
  geom_jitter(alpha=.2)+
  ggtitle("Interfocal Distances, ABS")+
...
oo.ifd <- ggplot(mouse.avs_4MM[ ( mouse.avs_4MM$sex == "male" ) & (mouse.avs_4MM$subsp == "Musc"),], aes(y = mean_IFD.2CO_PER, x= mouse, color=strain))+geom_boxplot(alpha=.2)+
  geom_jitter(alpha=.2)+
  ggtitle("Interfocal Distances, ABS")+
  scale_color_manual(values=colors_of_strains)+ facet_wrap(~strain, scales = "free")+ylim(c(0,1))+theme(legend.position="none")
