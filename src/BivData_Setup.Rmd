...
missing_from_cell_table <- BivData_from_15biv_cells[!BivData_from_15biv_cells$fileName %in% cell.level.BivData_table$fileName, ]#0, 
...
#broken again -- confusion between the number Q4 and the fileName
...
for(  i in 1:length( unique(BivData_from_15biv_cells$Obj.ID) ) ){
  ...
  #there is no Qar4 in this DF
  
  #print(c("the Q4  ",the.Q4)  )
  ...
  BivData_from_15biv_cells$Q4.FN[i] <- as.character(the.FN)  #this FN is NOT RIGHT
...
#save Rdata
save.image("~./MLH1repo/data/CleanBivData_3.2.20.RData")
