...
#mice to remove from the Curated_BivData -- should be similar to the mice exclude from the MLH1 (why?)
...
#save Rdata
save.image("~./MLH1repo/data/CleanBivData_6.3.20.RData")
