...
Main files from this plot:  
  ...
  7. **Strain DFs** for Het models
  
  8. **male Subsp DFs** for Polymorphism models
...
Curated_BivData_male <- Curated_BivData[ (Curated_BivData$sex == "male") & (Curated_BivData$species == ),]
