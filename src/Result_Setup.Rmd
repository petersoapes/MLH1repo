...
#No MOLF female for curated biv data
...
```{r Female.specific.glm.M4.M5-temp, echo=FALSE, eval=TRUE}
...
write.xlsx(as.data.frame( sum_IFD.PER.female.glm_M5$coefficients), "IFD.PER.male.glm_M5.xlsx", col.names = TRUE, row.names = TRUE)
