...
# Q1 single bivalent section and total SC
...
```{r Q1_SC.biv.short_ttest99, echo=FALSE, eval=FALSE}
#this show is re-dundant
#
#run t.tests for the mouse av. for reduced single bivalent datasets
