...
The molf male t-tests don't work because I only have total Sc measures for 1 MOLF male. to of the 


```{r Q2.totSC.ttest_old, echo=FALSE, eval=FALSE}
...
todo list if I get back to lab.
