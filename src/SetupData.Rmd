...
- try calq correlation of MLH1 counts across duplicates
...
MLH1_data = read.xlsx2(here("data", "/AnonData_formated.xlsx"), header=TRUE, 1)

#formating the original anon file
#MLH1_data = read.xlsx2(here("data", "/AnonData.xlsx"), header=TRUE, 1)
...
#write csv to MLH1 file
#write.xlsx2(MLH1_data, "AnonData_formated.xlsx", sheetName="Sheet1",
...
save.image("~./MLH1repo/data/MLH1/MLH1_data_setup_5.5.20.RData")
