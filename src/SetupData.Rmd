...
AP_mouse_table <- add_strain(AP_mouse_table.HQ)
...
male_mouse_table_w.Ages <- AP_mouse_table.HQ[(AP_mouse_table.HQ$sex == "male") &(mouse.table_w.Ages$category != "other"),]

all.ages_plot <- ggplot(AP_mouse_table.HQ, aes(age.weeks))+geom_histogram(binwidth = 3)+facet_wrap(~category)+ggtitle("Male Age Distributions")
all.ages_plot
...
save.image("~./MLH1repo/data/MLH1/MLH1_data_setup_11.11.19.RData")
